...
export default function Consultation() {
  return (
    <div className="bg-white w-full flex flex-col gap-3 pt-5 clip-custom-card pb-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-start gap-4 p-5  w-[98%] lg:w-[90%] mx-auto mb-2 ">
        <div className="w-full lg:w-1/2 flex flex-col justify-center gap-3">
          <p className="text-lg text-gray-600 mt-4">
            Describe your symptoms to our AI to receive tailored recommendations
            of medications from our database that fit within your budget.
          </p>
          <div className="p-8 flex flex-row bg-white shadow-md shadow-gray-400 gap-3 items-center outer-div">
            ...
            <p className="">
              Don't just get medication, get guidance! Tell our AI what's wrong
              and get instant recommendations based on your symptoms.
            </p>
          </div>
          <div className="p-8 flex flex-row bg-white shadow-md shadow-gray-400 gap-3 items-center outer-div">
            ...
            <p className="">
              Get supplementary information to help you make informed decisions
              about your health.
            </p>
          </div>
          <p className="text-lg text-gray-600 mt-4">
            Sign up for our medication management tools today and experience a
            simpler, more organized way to manage your health.
          </p>
